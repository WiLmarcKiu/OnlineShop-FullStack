...
<head>
	...
	<title>BEYOUTIFUL : Login Admin</title>
						...
						<div class="card-body">
							<form method="post">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="username" placeholder="Masukan Username anda" autocomplete="off" required>
								</div>
								<div class="form-group">
...
<?php 
	...
	if (isset($_POST["login"]))
	{
		...
		$ambil = $koneksi->query("SELECT * FROM admin WHERE username = '$username' AND password = 
			'$password'");
